...
Como já foi dito, todo dado usado é público e agregado — nada de informação pessoal de candidato real em nenhuma etapa. As personas de teste são fictícias, criadas só pra validar o comportamento do score.
